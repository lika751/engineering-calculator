...
class MemoryManager:
    ...
    def __init__(self):
        ...
        self.memory_status = False  # Флаг, что в памяти что-то есть
...
class CalculatorGUI:
    ...
    def create_widgets(self):
        ...
        buttons = [
            ...
            # Четвертый ряд: цифры и операции
            [
    ...
    def scientific_func(self, func):
        ...
        # Для констант просто подставляем значение
        if func in ["π", "e"]:
            if current == "0" or current == "Error":
            ...
            self.display_var.set(result)
        # Для функций нужен текущий аргумент
